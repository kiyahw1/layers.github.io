...
function imageChange() {
    ...
    if (frontback == "_Front.png") {
        document.getElementById("subject").src= "../SubjectCards"+filename.replace("_Front.png","_Back.png");
    } else {
        document.getElementById("subject").src= "../SubjectCards"+filename.replace("_Back.png","_Front.png");
    }
    alert
}