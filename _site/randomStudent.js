function drawStudents(){
    ...
    document.getElementById("student1").src= "../StudentCards/"+random1;
    ...
    document.getElementById("student2").src="../StudentCards/"+random2;
    for(var i = 0; i<deck.length;i++){
        if (deck[i]===random2){
           deck.splice(i,1);
       }
    ...
    document.getElementById("student3").src="../StudentCards/"+random3;
