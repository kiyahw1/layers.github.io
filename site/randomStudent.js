function drawStudents(){
    ...
    document.getElementById("student1").src= "../_assets/StudentCards/"+random1;
    ...
    document.getElementById("student2").src="../_assets/StudentCards/"+random2;
    for(var i = 0; i<deck.length;i++){
        if (deck[i]===random2){
           deck.splice(i,1);
       }
    ...
    document.getElementById("student3").src="../_assets/StudentCards/"+random3;
